...
var cacheDir = null, bean = null, inputFile = null, probeFile = null, ncpu = null, b_index = false, slurmOptions = null;
var optCacheDir = [];
//////////////// usage //////////////////
var usage = function () {
    let str = '\n\n  Example:\n\n';
...
commander
    ...
    .option('-p, --probe <string>', 'path to your probe PDB file [mandatory]', (val) => { probeFile = val; })
    .option('-n, --ncpu <integer>', 'number of CPUs needed [mandatory]', (val) => { ncpu = parseInt(val); })
